...
if (isset($_GET['q'])) {
    ...
    $datos = array();
    $nombre = $_GET['pro'];
   //$producto = mysqli_query($conexion, "SELECT * FROM producto WHERE codigo LIKE '%" . $nombre . "%' OR descripcion LIKE '%" . $nombre . "%' AND codproducto = 8");
   $producto = mysqli_query($conexion, "SELECT * FROM producto WHERE estado=1");
