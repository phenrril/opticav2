...
type SalesReportItem struct { // For individual line items in the report
	UserID            uint    `json:"id_usuario,omitempty"`
	SaleID            uint    `json:"id_venta,omitempty"` // Might be Sale ID or an Ingreso/Egreso ID
	ProductID         uint    `json:"id_producto,omitempty"`
