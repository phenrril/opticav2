...
type Sale struct {
	...
	PaymentMethodID  uint      `json:"id_metodo_pago" gorm:"column:id_metodo_pago"`
...
type Payment struct {
	...
	PaymentMethodID   uint      `json:"id_metodo_pago" gorm:"column:id_metodo_pago"`
	ProcessedByUserID uint      `json:"id_usuario_procesa" gorm:"column:id_usuario_procesa"`
	CreatedAt         time.Time `json:"created_at"`
...
type AddPaymentRequest struct {
	SaleID            uint    `json:"id_venta" binding:"required"`
